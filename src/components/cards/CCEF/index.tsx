const CCEFCard = () => {
  return (
    <>
      ...
      <p>
        Nommés par l&rsquo;Etat (ministre chargé du commerce extérieur) en raison de
        leurs compétences et de leur engagement, au sein de l&rsquo;équipe de France,
        au service des intérêts économiques de la France.
      </p>
      <p>
        Ils exercent bénévolement leur mission sous la forme d&rsquo;actions de
        promotion et d&rsquo;appui à l&rsquo;internationalisation des entreprises
        ...
        missions : le conseil aux pouvoirs publics, l&rsquo;appui aux entreprises, la
        formation des jeunes aux métiers de l&rsquo;international et la promotion de
        l&rsquo;attractivité de la France
      </p>
