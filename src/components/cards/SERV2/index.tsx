...
const SERV2 = () => {
  return (
    <>
      ...
      <p>
        La <strong>ligne de crédit de la DG Trésor</strong> destinée aux PME et
        PMI tunisiennes a pour objectifs de faciliter leur investissement
        productif dans un cadre privilégié et de renforcer leurs liens avec les
        entreprises françaises. Cette ligne de crédit est une solution globale
        qui facilite l&rsquo;accès au financement des PME et PMI tunisiennes,
        issues de tout secteur, pour l&rsquo;acquisition de biens et de services
        d&#39;origine française.
      </p>
      <a
