const SERV1 = () => {
  ...
  return (
    <>
      ...
      <p>
        Destiné à tous types d&rsquo;entreprises françaises, et prioritairement les
        PME, le FASEP est une subvention (ou une avance remboursable) pour <strong>des
        études de faisabilité ou des projets démonstrateurs de technologies
        vertes et innovantes au bénéfice d&rsquo;entités publiques des pays en
        développement.</strong> Dispositif de soutien à l&rsquo;internationalisation des
        entreprises françaises, le FASEP permet à l&rsquo;entreprise qui en bénéficie
        de démontrer l&rsquo;efficacité de ses méthodes et d&rsquo;acquérir une référence
      ...
      >
        <strong>Contact:</strong> Sarra BENATTIA, <strong>Téléphone:</strong> +216 31 315 093
      </a>
      <a
